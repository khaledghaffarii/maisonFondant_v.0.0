...
class ReparationTypeForme extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isFormValid: false,
  ...
  render() {
    ...
    const optionDevices = props.state.optionDevices;
    const suggestionDevice = Object.values(optionDevices).map((item) => ({
      key: item._id,
      value: item._id,
...
export default withTranslation()(withRouter(ReparationTypeForme));
