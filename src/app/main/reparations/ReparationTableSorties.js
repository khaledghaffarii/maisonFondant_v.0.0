...
class ReparationTableSorties extends Component {
  request = new Request();
  ...
  fetchData(query) {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      url += '&filters[]=etat,Récupéré par le Client|Irréparable|Irréparable payé';
...
export default withSnackbar(withRouter(ReparationTableSorties));