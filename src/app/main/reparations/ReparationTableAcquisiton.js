...
class ReparationTableAcquisition extends Component {
  request = new Request();
  ...
  fetchData(query) {
    return new Promise(async (resolve, reject) => {
      ...
      url += `&filters[]=etat,Nouveau Client|Déposé`
...
export default withSnackbar(withRouter(ReparationTableAcquisition));