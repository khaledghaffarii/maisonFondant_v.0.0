...
class ReparationTableCS extends Component {
  request = new Request();
  ...
  fetchData(query) {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      url += '&filters[]=etat,Sous Diagnostic|Prêt pour Transfert|Réparation en Cours|Diagnostic Terminé|Transféré au Spécialiste|Réparé';
...
export default withSnackbar(withRouter(ReparationTableCS));