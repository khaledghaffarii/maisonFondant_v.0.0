...
import LivreurComponent from "./LivreurComponent";
  ...
  render() {
    return (
      <Table
        ...
        title={
          <Translation>
            {(t) => <div>{t("plannings.plannings")}</div>}
          </Translation>
        }
        columns={this.state.columns}
        data={this.fetchData.bind(this)}
        showMore="/detailsPlanning"
        state={this.state}
...
export default withTranslation()(withSnackbar(withRouter(PlanningTable)));
