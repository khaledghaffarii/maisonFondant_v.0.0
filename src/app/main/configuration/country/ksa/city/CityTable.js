...
class CityTable extends Component {
  ...
  render() {
    return (
      <Table
        updated={false}
        title={<Translation>{(t) => <div>{t("city.city")}</div>}</Translation>}
...
export default withTranslation()(withSnackbar(withRouter(CityTable)));
