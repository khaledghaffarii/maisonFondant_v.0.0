  ...
  constructor(props) {
    ...
    this.state = {
      columns: [
        {
          title: (
            <Translation>{(t) => <div>{t("devis.number")}</div>}</Translation>
          ),
          field: "numero",
        },
        {
          title: (
            <Translation>
              {(t) => <div>{t("devis.reparation")}</div>}
            </Translation>
          ),
          field: "reparation",
          render: (rowData) => (
            <a href={`/devis/edit/${rowData._id}`}>
        ...
        {
          title: (
            <Translation>{(t) => <div>{t("devis.tva")}</div>}</Translation>
          ),
          field: "tva",
          render: (rowData) => <p> {rowData.tva + "%"}</p>,
        },
        {
          title: (
            <Translation>{(t) => <div>{t("devis.stamp")}</div>}</Translation>
          ),
          field: "timber",
        },
        {
          title: (
            <Translation>
              {(t) => <div>{t("devis.preTaxeAmount")}</div>}
            </Translation>
          ),
          field: "montant_ht",
        },
        ...
        },
        {
          ...
          render: (rowData) => (
            <p>
              {" "}
              {rowData.listPieces.map((listPieces) => (
                <>
                  Piece:{listPieces.piece?.displayName + " "} Quantite:
                  {listPieces.quantite + " "}Remise:{listPieces.remise + "% "}
                </>
              ))}
            </p>
          ),
        ...
        {
          title: (
            <Translation>{(t) => <div>{t("devis.notice")}</div>}</Translation>
          ),
          field: "remarque",
        },
        {
        ...
        {
          title: (
            <Translation>{(t) => <div>{t("devis.customer")}</div>}</Translation>
          ),
          field: "owner",
          render: (rowData) => (
            <p>
        ...
        },
        {
          ...
          render: (rowData) => (
            <p>
              {" "}
              {rowData.createdBy
                ? rowData.createdBy.fname + " " + rowData.createdBy.lname
                : ""}
            </p>
          ),
        },
        {
          ...
          render: (rowData) => (
            <p>
              {" "}
              {rowData.updatedBy
                ? rowData.updatedBy.fname + " " + rowData.updatedBy.lname
                : ""}
            </p>
          ),
        },
        {
          ...
          field: "Imprimer",
          render: (rowData) => (
            <a href={`/devis/imprimer/${rowData._id}`}>
              {" "}
              <Translation>{(t) => <div>{t("devis.print")}</div>}</Translation>
            </a>
          ),
  ...
  render() {
    return (
      <Table
        ...
        title={this.props.t("devis.quotes")}
        columns={this.state.columns}
        data={this.fetchData}
        routeEdit="/devis/edit"
        delete={this.delete}
