    ...
    return (
      <FusePageCarded
        ...
        header={
          <FormHeader
            returnRoute="/blog"
            title={this.props.t("devis.quotesDetails")}
          />
        }
        content={
              ...
              <CardContent className="flex flex-col items-center justify-center p-32">
                <Formsy className="flex flex-col justify-center w-full">
                  ...
                  <TextFieldFormsy
                    ...
                    label={this.props.t("boutique.name")}
                    name="name"
                    type="text"
                    margin="normal"
                    variant="outlined"
                  ...
                  <TextFieldFormsy
                    ...
                    label={this.props.t("product.price")}
                    name="prix"
                    type="number"
                    margin="normal"
                    variant="outlined"
                  ...
                  <TextFieldFormsy
                    ...
                    label={this.props.t("category.parent.title")}
                    name="parent"
                    type="text"
                    margin="normal"
                    variant="outlined"
                  ...
                  {this.state.show ? (
                    <TextFieldFormsy
                      ...
                      label={this.props.t(
                        "reparation.deviceInformation.DeviceColor"
                      )}
                      name="couleur"
                      type="text"
                      margin="normal"
...
export default withTranslation()(
  withStyles(styles, { withTheme: true })(
    withSnackbar(withRouter(DetailsDevis))
  )
);
