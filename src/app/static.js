...
const globalUrl = 'https://api.trustit.dev/';
const baseUrl = 'https://api.trustit.dev/' + user + '-api/v1/';
...
module.exports = {
	...
	gamme: {
		...
		gammeByBrandAndDevice: baseUrl + 'gamme/gammeByBrandAndDevice',
	},
	model: {
	...
	repairers: {
		...
		allByCountry: baseUrl + 'repairers/allByCountry',
		new: baseUrl + 'repairers/new',
		activate: (id) => `${baseUrl}repairers/activate/${id}`,
	...
	boutiques: {
		...
		allByCountry: baseUrl + 'boutiques/allByCountry',
	},
	specialities: {
	...
	region: {
		list: baseUrl + 'region/list',
		all: baseUrl + 'region/all',
	},
	city: {
		list: baseUrl + 'city/list',
		all: baseUrl + 'city/all',
		info: baseUrl + 'city/info',
	},
	gouvernorate: {
		list: baseUrl + 'gouvernorate/list',
		all: baseUrl + 'gouvernorate/all',
	},
	delegation: {
		list: baseUrl + 'delegations/list',
		all: baseUrl + 'delegations/all',
		info: baseUrl + 'delegations/info',
	},
	etat: {
	...
	clients: {
		...
		listDeletedClient: baseUrl + 'clients/listDeletedClient',
		all: baseUrl + 'clients/all',
		allByCountry: baseUrl + 'clients/allByCountry',
	...
	staticFiles: 'https://api.trustit.dev',
	...
	STATES_REPARATION: {
		...
		R108T: {
			LABEL_FR: 'Diagnostique terminée team',
			VALUE: 'R108T',
		},
		R109: {
